...
/**
 * Allows to provide a value passed as a command line argument.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(value = { ElementType.TYPE, ElementType.FIELD, ElementType.METHOD })
public @interface CommandLineArgument {
    /** Defines if the CLI argument is a single flag, or has a value.
     * @return true, if the argument has a value. */
    boolean hasValue() default true;

    /**
     * Get a list of possible CLI arguments. The first value in the list is returned as result.
