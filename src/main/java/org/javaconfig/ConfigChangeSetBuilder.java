...
public final class ConfigChangeSetBuilder {
    ...
    public ConfigChangeSetBuilder put(String key, String value) {
        this.delta.put(key, new PropertyChangeEvent(this.source, key, this.source.getOrDefault(key, null), Objects.requireNonNull(value)));
        return this;
    }
    ...
    public ConfigChangeSetBuilder put(String key, Boolean value) {
        this.delta.put(key, new PropertyChangeEvent(this.source, key, this.source.getOrDefault(key, null), Objects.requireNonNull(value).toString()));
        return this;
    }
    ...
    public ConfigChangeSetBuilder putAll(Map<String,String> changes) {
        changes.forEach((k,v) ->
                this.delta.put(k, new PropertyChangeEvent(this.source, k, this.source.getOrDefault(k, null), v)));
        return this;
    }
    ...
    public static Collection<PropertyChangeEvent> compare(PropertyProvider map1, PropertyProvider map2) {
        ...
        for (Map.Entry<String, String> en : map1.toMap().entrySet()) {
            ...
            if(val==null || !val.equals(en.getValue()))
