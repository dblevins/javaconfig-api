...
* _JUG Berlin Brandenburg_ is one of the bigger JUGs in Germany and also would contribute to this project.
* _JUG Zurich_ organizes regular (monthly) Hackergarten and will contribute to this project as well.
